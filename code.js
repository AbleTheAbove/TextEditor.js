...
const newTab = (filename) => {
  ...
  textareas.getElementsByClassName("active")[0].classList.remove("active");
  textareas.innerHTML += " <textarea id=\"tab" + tabs.childElementCount + "code\" class=\"code active\" rows=\"60\" cols=\"201\" nowrap=\"nowrap\" wrap=\"off\" spellcheck=\"false\" onscroll=\"scrollNums(this)\"></textarea>";
}
